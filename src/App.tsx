...
const exportToGitHub = async () => {
  ...
  if (!session?.provider_token) {
    await supabase.auth.signInWithOAuth({
      ...
      options: {
        scopes: 'repo',
        redirectTo: 'https://sdk-web.vercel.app'
      }
    });
    return;
  }
  ...
  try {
    ...
    if (!createRes.ok) throw new Error(repo.message);
    ...
    alert(`✅ Exported to GitHub: ${repo.html_url}`);
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        {result && (
          <div style={{ marginTop: "16px", textAlign: "center" }}>
            <button onClick={exportToGitHub} style={{
